...
(fset 'subir-e-centralizar
   (kmacro-lambda-form [?k ?z ?z] 0 "%d"))
(fset 'descer-e-centralizar
   (kmacro-lambda-form [?j ?z ?z] 0 "%d"))
...
(define-key evil-normal-state-map (kbd "<up>") 'subir-e-centralizar)
(define-key evil-normal-state-map (kbd "<down>") 'descer-e-centralizar)
