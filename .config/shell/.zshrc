...
git_confirm () {
    ...
    read resposta
    if echo "$resposta" | grep -q "yes" ;then
       eval $git_cmd
    fi
}
...
alias gaf="git add -f"
alias gap="git add -p"
alias gcm="git_confirm commit"
alias gcam="git_confirm commit-amend"
alias gca="git_confirm commit-amend-no-edit"
alias gco="git checkout"
alias gps="git_confirm push"
alias gpsf="git_confirm push-f"
alias gpl="git_confirm pull"
alias gf="git_confirm fetch"
alias gr="git_confirm restore"
alias grv="git remote -v"
alias grs="git_confirm restore-staged"
alias grsu="git_confirm remote-set-url-origin"
alias grrs="git_confirm reset-soft"
alias grrh="git_confirm reset-hard"
