...
if [ "$PC" = "voidlinux" ]; then
    ...
    alias xsyu="doas xbps-install -Su"
    alias xq="xbps-query -l"
    alias xqs="xbps-query -l | grep --color -i"
    alias xrns="doas xbps-remove -R"
    ...
    # apt
    alias bat="batcat"
    alias as="doas apt install"
    alias asi="apt show"
    alias ass="apt search"
    alias asyu="doas apt update && doas apt upgrade"
    alias aq="apt list --installed"
    alias aqs="apt list --installed | grep --color -i"
    alias arns="doas apt remove"
fi
