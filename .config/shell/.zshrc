...
# git bare dotfiles
git () {
    if [ $(pwd) = $HOME ] && [ $1 != "init" ] && [ $1 != "clone" ]; then
        /usr/bin/git --work-tree=. --git-dir="$HOME/etc/.dotfiles/" $@
    else
        /usr/bin/git $@
    fi
}
...
alias tep="trans en:pt"
alias tpe="trans pt:en"
alias fm="fzf_man"
...
alias dnbp="dotnet build --project"
alias dnp="dotnet publish"
alias dnap="dotnet add package"
alias dnar="dotnet add reference"
alias dnw="dotnet watch"
alias dnwp="dotnet watch --project"
alias dti="dotnet tool install -g"
alias dtu="dotnet tool uninstall -g"
alias dts="dotnet tool search"
alias dtl="dotnet tool list -g"
alias dnsa="dotnet sln add"
alias dnsl="dotnet sln list"
alias dnsr="dotnet sln remove"
