...
config.set('content.javascript.enabled', True, '*://*.freedesktop.org/*')
...
config.set('colors.webpage.darkmode.enabled', True, '*://*.pt.aliexpress.com/*')
...
config.set('colors.webpage.darkmode.enabled', True, '*://*.stackoverflow.com/*')
config.set('content.javascript.enabled', True, '*://*.www.casalmonstro.com.br/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.casalmonstro.com.br/*')
config.set('content.javascript.enabled', True, '*://*.www.mercadolivre.com.br/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.mercadolivre.com.br/*')
config.set('content.javascript.enabled', True, '*://*.login.aliexpress.com/*')
config.set('content.javascript.enabled', True, '*://*.thirdparty.aliexpress.com/*')
config.set('content.javascript.enabled', True, '*://*.www.wolframalpha.com/*')
config.set('content.javascript.enabled', True, '*://*.www.computerenhance.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.computerenhance.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.mercadolivre.com/*')
config.set('content.javascript.enabled', True, '*://*.www.mercadolivre.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.lista.mercadolivre.com.br/*')
config.set('content.javascript.enabled', True, '*://*.produto.mercadolivre.com.br/*')
...
config.set('content.javascript.enabled', True, '*://*.xdaforums.com/*')
config.set('content.javascript.enabled', True, '*://*.www.tudocelular.com/*')
config.set('content.javascript.enabled', True, '*://*.www.motorola.com.br/*')
config.set('content.javascript.enabled', True, '*://*.hangout.audio/*')
config.set('content.javascript.enabled', True, '*://*.urbit.org/*')
config.set('content.javascript.enabled', True, '*://*.versus.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.en.wikipedia.org/*')
config.set('content.javascript.enabled', True, '*://*.www.gsuplementos.com.br/*')
...
config.set('colors.webpage.darkmode.enabled', True, '*://*.csharpier.com/*')
config.set('content.javascript.enabled', True, '*://*.herbie.uwplse.org/*')
config.set('content.javascript.enabled', True, '*://*.chromewebstore.google.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.chromewebstore.google.com/*')
config.set('content.javascript.enabled', True, '*://*.www.surveymonkey.com/*')
config.set('content.javascript.enabled', True, '*://*.obsproject.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.askubuntu.com/*')
config.set('content.javascript.enabled', True, '*://*.click.discord.com/*')
config.set('content.javascript.enabled', True, '*://*.github.surveymonkey.com/*')
config.set('content.javascript.enabled', True, '*://*.code.visualstudio.com/*')
config.set('content.javascript.enabled', True, '*://*.clips.twitch.tv/*')
...
config.set('content.javascript.enabled', True, '*://*.uops.info/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.uops.info/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.gcc.gnu.org/*')
config.set('content.javascript.enabled', True, '*://*.hub.docker.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.apps.microsoft.com/*')
config.set('content.javascript.enabled', True, '*://*.apps.microsoft.com/*')
config.set('content.javascript.enabled', True, '*://*.xahlee.info/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.x.org/*')
config.set('content.javascript.enabled', True, '*://*.www.x.org/*')
config.set('content.javascript.enabled', True, '*://*.exchangerate.host/*')
config.set('content.javascript.enabled', True, '*://*.openexchangerates.org/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.news.ycombinator.com/*')
config.set('content.javascript.enabled', True, '*://*.www.unitconverters.net/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.unitconverters.net/*')
config.set('content.javascript.enabled', True, '*://*.www.appicon.co/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.wiki.lineageos.org/*')
config.set('content.javascript.enabled', True, '*://*.download.lineageos.org/*')
config.set('content.javascript.enabled', True, '*://*.developer.android.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.developer.android.com/*')
config.set('content.javascript.enabled', True, '*://*.auth.openai.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.number-none.com/*')
config.set('content.javascript.enabled', True, '*://*.number-none.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.groups.google.com/*')
config.set('content.javascript.enabled', True, '*://*.groups.google.com/*')
config.set('content.javascript.enabled', True, '*://*.devblogs.microsoft.com/*')
config.set('content.javascript.enabled', True, '*://*.xcancel.com/*')
config.set('content.javascript.enabled', True, '*://*.myactivity.google.com/*')
config.set('content.javascript.enabled', True, '*://*.www.geeksforgeeks.org/*')
config.set('content.javascript.enabled', True, '*://*.mastodon.gamedev.place/*')
config.set('content.javascript.enabled', True, '*://*.dev.azure.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.blog.adacore.com/*')
config.set('content.javascript.enabled', True, '*://*.devdocs.io/*')
config.set('content.javascript.enabled', True, '*://*.trello.com/*')
config.set('content.javascript.enabled', True, '*://*.cs.rin.ru/*')
config.set('content.javascript.enabled', True, '*://*.steamdb.info/*')
config.set('content.javascript.enabled', True, '*://*.se7en.ws/*')
config.set('content.javascript.enabled', True, '*://*.www.amazon.com.br/*')
config.set('content.javascript.enabled', True, '*://*.bsky.app/*')
config.set('content.javascript.enabled', True, '*://*.platform.openai.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.ollama.com/*')
config.set('content.javascript.enabled', True, '*://*.ollama.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.dictionary.cambridge.org/*')
config.set('content.javascript.enabled', True, '*://*.dictionary.cambridge.org/*')
config.set('content.javascript.enabled', True, '*://*.auth.mercadolivre.com.br/*')
config.set('content.javascript.enabled', True, '*://*.www.infopedia.pt/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.infopedia.pt/*')
config.set('content.javascript.enabled', True, '*://*.www.convertworld.com/*')
config.set('content.javascript.enabled', True, '*://*.www.head-fi.org/*')
config.set('content.javascript.enabled', True, '*://*.mahjongsoul.yo-star.com/*')
config.set('content.javascript.enabled', True, '*://*.mahjongsoul.game.yo-star.com/*')
config.set('content.javascript.enabled', True, '*://*.myaccount.mercadolivre.com.br/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.myaccount.mercadolivre.com.br/*')
config.set('colors.webpage.darkmode.enabled', True, 'qute://help/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.w3.org/*')
config.set('content.javascript.enabled', True, '*://*.webaim.org/*')
config.set('content.javascript.enabled', True, '*://*.rgbacolorpicker.com/*')
config.set('content.javascript.enabled', True, '*://*.fdc.nal.usda.gov/*')
config.set('content.javascript.enabled', True, '*://*.www.matematica.pt/*')
config.set('content.javascript.enabled', True, '*://*.www.pichau.com.br/*')
config.set('content.javascript.enabled', True, '*://*.www.lenovo.com/*')
config.set('content.javascript.enabled', True, '*://*.www.cpubenchmark.net/*')
config.set('content.javascript.enabled', True, '*://*.www.passmark.com/*')
config.set('content.javascript.enabled', True, '*://*.sso.acesso.gov.br/*')
config.set('content.javascript.enabled', True, '*://*.servicos.mte.gov.br/*')
config.set('content.javascript.enabled', True, '*://*.lwn.net/*')
config.set('content.javascript.enabled', True, '*://*.dotnet.github.io/*')
config.set('content.javascript.enabled', True, '*://*.flattened.net/*')
config.set('content.javascript.enabled', True, '*://*.live.colonq.computer/*')
config.set('content.javascript.enabled', True, '*://*.developer.apple.com/*')
config.set('content.javascript.enabled', True, '*://*.idmsa.apple.com/*')
config.set('content.javascript.enabled', True, '*://*.account.apple.com/*')
config.set('content.javascript.enabled', True, '*://*.sourceforge.net/*')
config.set('content.javascript.enabled', True, '*://*.www.terabyteshop.com.br/*')
config.set('content.javascript.enabled', True, '*://*.wiki.postmarketos.org/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.wiki.postmarketos.org/*')
config.set('content.javascript.enabled', True, '*://*.pkgs.alpinelinux.org/*')
config.set('content.javascript.enabled', True, '*://*.www.tiktok.com/*')
config.set('content.javascript.enabled', True, '*://*.matrix.to/*')
config.set('content.javascript.enabled', True, '*://*.developers.google.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.chimera-linux.org/*')
config.set('content.javascript.enabled', True, '*://*.chimera-linux.org/*')
config.set('content.javascript.enabled', True, '*://*.wiki.archlinux.org/*')
config.set('content.javascript.enabled', True, '*://*.dotnet.microsoft.com/*')
config.set('content.javascript.enabled', True, '*://*.nyaa.si/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.sqlite.org/*')
config.set('content.javascript.enabled', True, '*://*.sqlite.org/*')
config.set('content.javascript.enabled', True, '*://*.emmylua.github.io/*')
config.set('content.javascript.enabled', True, '*://*.luals.github.io/*')
config.set('content.javascript.enabled', True, '*://*.strawpoll.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.justine.lol/*')
config.set('content.javascript.enabled', True, '*://*.justine.lol/*')
config.set('content.javascript.enabled', True, '*://*.yazi-rs.github.io/*')
config.set('content.javascript.enabled', True, '*://*.meu.inss.gov.br/*')
config.set('content.javascript.enabled', True, '*://*.www.tse.jus.br/*')
config.set('content.javascript.enabled', True, '*://*.www.destiny.gg/*')
config.set('content.javascript.enabled', True, '*://*.labs.google.com/*')
config.set('content.javascript.enabled', True, '*://*.www.zerotier.com/*')
config.set('content.javascript.enabled', True, '*://*.my.zerotier.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.my.zerotier.com/*')
config.set('content.javascript.enabled', True, '*://*.joinzt.com/*')
config.set('content.javascript.enabled', True, '*://*.www.meualelo.com.br/*')
config.set('content.javascript.enabled', True, '*://*.account.live.com/*')
config.set('content.javascript.enabled', True, '*://*.lists.gnu.org/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.lists.gnu.org/*')
config.set('content.javascript.enabled', True, '*://*.www.paypal.com/*')
config.set('content.javascript.enabled', True, '*://*.www.worldtimebuddy.com/*')
config.set('content.javascript.enabled', True, '*://*.rustlesearch.dev/*')
config.set('content.javascript.enabled', True, '*://*.peqdb.com/*')
config.set('content.javascript.enabled', True, '*://*.boards.4chan.org/*')
config.set('content.javascript.enabled', True, '*://*.audius.co/*')
config.set('content.javascript.enabled', True, '*://*.hypeddit.com/*')
config.set('content.javascript.enabled', True, '*://*.www.toneden.io/*')
config.set('content.javascript.enabled', True, '*://*.www.patreon.com/*')
config.set('content.javascript.enabled', True, '*://*.bandcamp.com/*')
config.set('content.javascript.enabled', True, '*://*.www.olx.com.br/*')
config.set('content.javascript.enabled', True, '*://*.sp.olx.com.br/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.sp.olx.com.br/*')
...
config.set('content.javascript.enabled', True, '*://*.sr.ht/*')
...
config.set('colors.webpage.darkmode.enabled', True, '*://*.research.swtch.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.swtch.com/*')
config.set('content.javascript.enabled', True, '*://*.www.nytimes.com/*')
config.set('content.javascript.enabled', True, '*://*.kami.bearblog.dev/*')
config.set('content.javascript.enabled', True, '*://*.qutebrowser.org/*')
config.set('content.javascript.enabled', True, '*://*.flash.android.com/*')
config.set('content.javascript.enabled', True, '*://*.www.selenium.dev/*')
config.set('content.javascript.enabled', True, '*://*.pypi.org/*')
config.set('content.javascript.enabled', True, '*://*.substack.com/*')
...
config.set('content.javascript.enabled', True, '*://*.bettersoftwareconference.com/*')
config.set('content.javascript.enabled', True, '*://*.source.chromium.org/*')
config.set('content.javascript.enabled', True, '*://*.throne.com/*')
config.set('content.javascript.enabled', True, '*://*.ko-fi.com/*')
config.set('content.javascript.enabled', True, '*://*.www.amazon.com/*')
config.set('content.javascript.enabled', True, '*://*.open.substack.com/*')
config.set('content.javascript.enabled', True, '*://*.challenge.spotify.com/*')
config.set('content.javascript.enabled', True, '*://*.developer.spotify.com/*')
config.set('content.javascript.enabled', True, '*://*.4chansearch.com/*')
config.set('content.javascript.enabled', True, '*://*.desuarchive.org/*')
config.set('content.javascript.enabled', True, '*://*.pumpyoursound.com/*')
config.set('content.javascript.enabled', True, '*://*.streamscharts.com/*')
config.set('content.javascript.enabled', True, '*://*.secure.soundcloud.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.techcrunch.com/*')
config.set('content.javascript.enabled', True, '*://*.www.livechart.me/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.livechart.me/*')
config.set('content.javascript.enabled', True, '*://*.www.derekthompson.org/*')
config.set('content.javascript.enabled', True, '*://*.fishshell.com/*')
config.set('content.javascript.enabled', True, '*://*.claude.ai/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.derekthompson.org/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.bbc.com/*')
config.set('content.javascript.enabled', True, '*://*.www.bbc.com/*')
config.set('content.javascript.enabled', True, '*://*.deltarune.wiki/*')
config.set('content.javascript.enabled', True, '*://*.vimm.net/*')
config.set('content.javascript.enabled', True, '*://*.appdb.winehq.org/*')
config.set('content.javascript.enabled', True, '*://*.www.theverge.com/*')
config.set('content.javascript.enabled', True, '*://*.arstechnica.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.docs.gimp.org/*')
config.set('content.javascript.enabled', True, '*://*.es.pinterest.com/*')
config.set('content.javascript.enabled', True, '*://*.madeinabyss.fandom.com/*')
config.set('content.javascript.enabled', True, '*://*.lutris.net/*')
config.set('content.javascript.enabled', True, '*://*.fanlink.tv/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.tech.stonecharioteer.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.utcc.utoronto.ca/*')
config.set('content.javascript.enabled', True, '*://*.utcc.utoronto.ca/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.web.archive.org/*')
config.set('content.javascript.enabled', True, '*://*.suaconta.kuba.audio/*')
config.set('content.javascript.enabled', True, '*://*.kuba.audio/*')
config.set('content.javascript.enabled', True, '*://*.claude.com/*')
config.set('content.javascript.enabled', True, '*://*.console.anthropic.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.yazi-rs.github.io/*')
config.set('content.javascript.enabled', True, '*://*.hn.algolia.com/*')
config.set('content.javascript.enabled', True, '*://*.doc.qt.io/*')
config.set('content.javascript.enabled', True, '*://*.playwright.dev/*')
config.set('content.javascript.enabled', True, '*://*.docs.cypress.io/*')
config.set('content.javascript.enabled', True, '*://*.pydoll.tech/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.tadaima.bearblog.dev/*')
config.set('content.javascript.enabled', True, '*://*.tadaima.bearblog.dev/*')
config.set('content.javascript.enabled', True, '*://*.docs.rs/*')
...
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.sebastianaaltonen.com/*')
config.set('content.javascript.enabled', True, '*://*.massgrave.dev/*')
config.set('content.javascript.enabled', True, '*://*.archive.ph/*')
config.set('content.javascript.enabled', True, '*://*.x1337x.cc/*')
config.set('content.javascript.enabled', True, '*://*.rentry.org/*')
config.set('content.javascript.enabled', True, '*://*.rarbgdump.com/*')
config.set('content.javascript.enabled', True, '*://*.learnxinyminutes.com/*')
config.set('content.javascript.enabled', True, '*://*.www.rfleury.com/*')
config.set('content.javascript.enabled', True, '*://*.developer.mozilla.org/*')
config.set('content.javascript.enabled', True, '*://*.www.grammarcheck.net/*')
config.set('content.javascript.enabled', True, '*://*.webcammictest.com/*')
config.set('content.javascript.enabled', True, '*://*.hachyderm.io/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.gnu.org/*')
config.set('content.javascript.enabled', True, '*://*.jnovels.com/*')
config.set('content.javascript.enabled', True, '*://*.mp4directs.com/*')
config.set('content.javascript.enabled', True, '*://*.www.climatempo.com.br/*')
config.set('content.javascript.enabled', True, '*://*.meuscorreios.app/*')
config.set('content.javascript.enabled', True, '*://*.cas.correios.com.br/*')
config.set('content.javascript.enabled', True, '*://*.faleconosco.correios.com.br/*')
config.set('content.javascript.enabled', True, '*://*.meucorreios.correios.com.br/*')
config.set('content.javascript.enabled', True, '*://*.dl.acm.org/*')
config.set('content.javascript.enabled', True, '*://*.jenn.site/*')
config.set('content.javascript.enabled', True, '*://*.lucumr.pocoo.org/*')
config.set('content.javascript.enabled', True, '*://*.lcamtuf.substack.com/*')
config.set('content.javascript.enabled', True, '*://*.trends.google.com/*')
config.set('content.javascript.enabled', True, '*://*.gamedate.org/*')
config.set('content.javascript.enabled', True, '*://*.www.mindtheheadphone.com.br/*')
config.set('content.javascript.enabled', True, '*://*.danbooru.donmai.us/*')
config.set('content.javascript.enabled', True, '*://*.git.kernel.org/*')
config.set('content.javascript.enabled', True, '*://*.www.tp-link.com/*')
config.set('content.javascript.enabled', True, '*://*.openwrt.org/*')
config.set('content.javascript.enabled', True, '*://*.enclose.horse/*')
config.set('content.javascript.enabled', True, '*://*.www.reuters.com/*')
config.set('content.javascript.enabled', True, '*://*.linktr.ee/*')
config.set('content.javascript.enabled', True, '*://*.dialed.gg/*')
config.set('content.javascript.enabled', True, '*://*.kanadojo.com/*')
config.set('content.javascript.enabled', True, '*://*.www.persuasion.community/*')
config.set('content.javascript.enabled', True, '*://*.www.astralcodexten.com/*')
config.set('content.javascript.enabled', True, '*://*.thesmallermajority.com/*')
config.set('content.javascript.enabled', True, '*://*.www.w3.org/*')
config.set('content.javascript.enabled', True, '*://*.www.theargumentmag.com/*')
config.set('content.javascript.enabled', True, '*://*.www.pangram.com/*')
config.set('content.javascript.enabled', True, '*://*.gptzero.me/*')
config.set('content.javascript.enabled', True, '*://*.www.melonbooks.co.jp/*')
config.set('content.javascript.enabled', True, '*://*.daringfireball.net/*')
config.set('content.javascript.enabled', True, '*://*.developers.openai.com/*')
config.set('content.javascript.enabled', True, '*://*.opencode.ai/*')
config.set('content.javascript.enabled', True, '*://*.login.tailscale.com/*')
config.set('content.javascript.enabled', True, '*://*.issuetracker.google.com/*')
config.set('content.javascript.enabled', True, '*://*.android-review.googlesource.com/*')
config.set('content.javascript.enabled', True, '*://*.discuss.grapheneos.org/*')
config.set('content.javascript.enabled', True, '*://*.nixos.wiki/*')
config.set('content.javascript.enabled', True, '*://*.nix.dev/*')
config.set('content.javascript.enabled', True, '*://*.nixpk.gs/*')
config.set('content.javascript.enabled', True, '*://*.noogle.dev/*')
config.set('content.javascript.enabled', True, '*://*.pbxscience.com/*')
config.set('colors.webpage.darkmode.enabled', True, '*://*.www.persuasion.community/*')
...
config.set('content.javascript.enabled', True, '*://*.medium.com/*')
config.set('content.javascript.enabled', True, '*://*.openai.com/*')
config.set('content.javascript.enabled', True, '*://*.wayland.app/*')
config.set('content.javascript.enabled', True, '*://*.booth.pm/*')
config.set('content.javascript.enabled', True, '*://*.www.reclameaqui.com.br/*')
config.set('content.javascript.enabled', True, '*://*.opensource.org/*')
config.set('content.javascript.enabled', True, '*://*.tplinkwifi.net/*')
