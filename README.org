...
- [[https://github.com/LucasTavaresA/dotfiles/blob/main/.config/emacs/init.org][Minha configuração do emacs]]
...
export CM_DIR="$HOME/code/dmenuscripts/listas/clipmenu"
clipmenud &
...
#+begin_src conf :tangle ~/.config/sxhkd/sxhkdrc_bspwm
# Fecha janela
super + backslash
	bspc node -c
...
#+begin_src conf :tangle ~/.config/bspwm/bspwmrc
#!/bin/sh
